 ...
 * 
 * Copied from Croogo with minimal modification
 */
 ...
 * @access public
 */
    public $helpers = array('Html', 'Form', 'System.Filemanager');
    ...
    public function beforeFilter() {
        ...
        // Set default config, if it doesn't exist in core.x.php
        $config = Configure::read('FileManager.options');
        if (blank($config)){
        	Configure::write('FileManager.options', 
					array(
						'DIR' => WWW_ROOT . 'img' . DS, 	// ends with slash
